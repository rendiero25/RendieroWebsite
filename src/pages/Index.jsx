                ...
                <div className="h-full lg:h-[55vh] w-full flex flex-col lg:flex-row justify-between items-start gap-8 px-8 pb-8 pt-4">
                    ...
                    <div className="w-full lg:w-[20%] h-full">
                        <div className="flex flex-col justify-between items-center gap-8 h-full">
                            ...
                            <button onClick={() => goToMedium()} className="cursor-pointer hover:scale-110 hover:shadow-2xl w-full h-full">
                                ...
                                >
                                    <h2 className="font-secondary text-black text-left text-5xl lg:text-2xl 2xl:text-4xl 3xl:text-4xl font-medium leading-tight uppercase self-start">CODING, COFFEE, AND GAMING</h2>
                    ...
                    >
                        ...
                        <p className="text-white text-2xl sm:text-3xl lg:text-xs 2xl:text-xl 3xl:text-xl font-normal text-left leading-normal">
                            ...
                            and mobile developerskilled in React JS, React Native, TailwindCSS, Nativewind,
